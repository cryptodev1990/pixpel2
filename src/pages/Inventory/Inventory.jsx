      ...
      <div className="inventory-card">
        <div className="inventory-card__img">
          <img
            ...
            className="inventory-card__picture"
            alt=""
          />
        </div>
        <div className="inventory-card__text">-16%</div>
      </div>
    ));
  }
    ...
    <>
      <div className="inventory">
        <div className="container">
          <h1 className="title inventory__title">Inventory</h1>
          <div className="inventory__row">
            <div
              className="inventory__col widget"
              style={{
                height: "100%",
                width: "100%",
                maxWidth: 780,
            ...
            <div className="inventory__col" style={{ width: 940 }}>
              <div className="inventory__row row-wrap">{card()}</div>
            </div>
          </div>
        </div>
      </div>
