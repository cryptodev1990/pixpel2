      ...
      <div className="flex gap-8">
        <div className={cartClicked ? "w-4/5" : "w-full"}>
          <div className="flex justify-between mb-7">
            <div className="flex gap-3">
              ...
              <div
                className={
                  ...
                  "flex bg-app-black gap-2 rounded-md items-center h-15 justify-center cursor-pointer"
                }
              >
            ...
            <div
              className="bg-app-black rounded-md gap-2 flex justify-center items-center w-33 h-15 cursor-pointer"
          ...
          >
            {NFTCardList.map((nft, idx) => {
              return <NFTCard key={idx} image={nft.img} />;
            })}
          </div>
        </div>
      </div>
