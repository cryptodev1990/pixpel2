...
import GameCard from "../../components/Market/GameCard/GameCard";
...
const GameMarket = () => {
  ...
  return (
    <div className="flex flex-col pb-40 px-36">
      <div className="text-4xl mb-6 font-bold">Game Marketplace</div>
      ...
      <div className="flex gap-5">
        <div className={cartClicked ? "w-4/5" : "w-full"}>
          ...
          <div
            className={
              (cartClicked ? "grid-cols-4" : "grid-cols-5") + " grid gap-3"
            }
          >
