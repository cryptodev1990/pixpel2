...
function SwapMaster() {
  ...
  const handleClickArrow = () => {
    navigate("/wallet?x=2", {replace: true});
  };
    ...
    <>
      <div className="flex flex-col items-center py-12" style={{fontFamily:"Poppins"}}>
        <div className="flex flex-row items-center justify-around w-full mb-5">
          <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-app-black-button hover:bg-app-blue"
               onClick={handleClickArrow}>
            <svg className="h-6 w-6 text-white"  width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" 
          ...
          <div className="1xs:text-[40px] 2xs:text-3xl text-2xl">
            Swap Master
          </div>
