...
const MarketSuccessCard = () => {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center px-12 py-12 bg-app-black rounded-xl"
        style={{ width: "521px", height: "559px" }}
      >
        <div
        ...
        <div className="flex justify-center mb-5">
          <div className="text-2xl font-medium">27.13898 USDT</div>
        </div>
        <div className="flex flex-row justify-between w-full mb-3">
          <div className="text-sm font-normal">Converted</div>
          <div className="text-sm font-normal">0.00065871 BTC</div>
        </div>
        <div className="flex flex-row justify-between w-full mb-3">
          <div className="text-sm font-normal">Price</div>
          <div className="text-sm font-normal">1 USDT = 0.00002427 BTC</div>
        </div>
        <div className="flex flex-row justify-between w-full mb-5">
          <div className="text-sm font-normal">Inverse Price</div>
          <div className="text-sm font-normal">1 BTC = 41201.8 USDT</div>
        </div>
        <div className="flex flex-row justify-between w-full">
          <div
            className="flex items-center justify-center h-16 px-20 py-5 rounded-lg cursor-pointer bg-app-black-button hover:bg-app-blue"
          ...
          <div className="flex items-center justify-center h-16 px-12 py-5 rounded-lg cursor-pointer bg-app-blue hover:bg-app-blue">
            <div className="text-lg font-medium">View Status</div>
          </div>
        </div>
      </div>
    </>
