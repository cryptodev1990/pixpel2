...
const Burn = () => {
  ...
  return (
    <div className="px-32 flex flex-col">
          ...
          <table className="tablt-auto">
            ...
            <tbody className="px-5">
              <tr>
                ...
                <td className="px-6">
                  <DropDownButton initialContent="Wallet" contentList={walletList} backgroundColor="bg-app-black-select" />
                </td>
                <td className="px-6">
      ...
      <div className="bg-app-green mx-10 px-8 py-4 rounded-lg mb-28 w-max cursor-pointer">+ ADD</div>
      <div className="flex justify-center">
        <div className="bg-app-blue rounded px-32 py-5 cursor-pointer">BURN</div>
      </div>
    </div>
  );
};
