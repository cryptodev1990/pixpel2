      ...
      <div className='flex flex-col w-1/5 gap-2'>
        {
          bankButtonList.map((bankButton, idx) => {
            return(
              <Button key={idx} title={bankButton.name} buttonStyle={"h-14 w-full xs:text-base font-semibold truncate text-sm"}
                      selected={(bankButton.id === 2 ? true : false)}/>
            )       
          })
        }
      </div>
