			...
			{props.showModal ? (
                ...
                <ImageDropDownButton initialContent={tokenList[0]} contentList={tokenList} backgroundColor={" bg-app-black-button"}/>
								<div className="flex flex-col">
									...
									<input className="h-16 pl-4 rounded-md bg-app-black-button placeholder:text-slate-600 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1" 
