  ...
  return (
    <>
      <div className="home">
              ...
              <div className="row row--space-between">
                <div className="col-lg-3">
                  <div className="banner__card">
                    ...
                    <p className="text banner__card-text">
            ...
            <div className="section__row">
              <div className="section__card">
                ...
                <div className="text section__card-text">
                  Party that hold the value of the NFT, avoiding rug pull and
                  rug slip. The value of the NFT is holded in stablecoins pixpel
                  coins or the game token
                </div>
              </div>
              <div className="section__card">
                <div className="section__card-title">
        ...
        <div className="container-fluid">
          <Banner
            bannerBg={"assets/images/home/main__bg.jpg"}
            classes="banner--offset-bottom"
          >
            <div className="container">
              <h1 className="title banner__title">PLAY 2 EARN, SAFE AND FUN</h1>
        ...
        <div className="container-fluid">
          <Banner
            bannerBg={"assets/images/home/footer__bg.jpg"}
            classes="banner--offset-bottom"
          >
            <div className="container">
              <h1 className="title banner__title">PLAY 2 EARN, SAFE AND FUN</h1>
