          ...
          <div className="exchange__container">
            <div className="head">
              ...
              <div className="head__tab">
                0.6149
                <div className="head__tab-heading-bottom">0.6149</div>
              </div>
              <div className="head__tab">
                <div className="head__heading-bottom">24h Change</div>
                0.6149
              </div>
              <div className="head__tab">
                <div className="head__heading-bottom">24h Low</div>
                0.6149
              </div>
              <div className="head__tab">
                <div className="head__heading-bottom">24h Volume(ALPACA)</div>
                0.6149
              </div>
              <div className="head__tab">
                <div className="head__heading-bottom">24h Volume(USD)</div>
                0.6149
              </div>
            </div>
            <div className="market">
              <div className="exchange__list exchange__box market__box market--offset">
                <div className="exchange__list-heading">
                  <div className="exchange__list-item">Price(USDT)</div>
                  <div className="exchange__list-item">Amount(BTC)</div>
                  <div className="exchange__list-item">Total</div>
                </div>
                <div className="exchange__list-row">
                  <div className="exchange__list-item exchange__list-item--sell">
                    40428.38
                  </div>
                  <div className="exchange__list-item">40428.38</div>
                  <div className="exchange__list-item">40428.38</div>
                </div>
                <div className="exchange__list-row">
                    ...
                    <div className="exchange__box orderform__box">
                      <div className="orderform__header">
                        ...
                        <div className="orderform__header-col">
                          ...
                          >
                            Buy with{" "}
                            <span className="orderform__header-currency orderform__header-currency--offset">
                              USD
                            </span>
                            <svg
                              width="7"
                      ...
                      <div className="orderform__main">
                        <div className="orderform__main-col">
                          <div className="orderform__main-heading">
                            <div className="orderform__main-heading-name">
                              Available
                            </div>
                            <div className="orderform__main-heading-price">
                              0.050930000 USDT
                            </div>
                          </div>
                          <div className="exchange__input-wrap exchange__input-wrap--offset">
                            <input
                              type="text"
                              placeholder="Price"
                              className="exchange__input orderform__main-input"
                            />
                            <div className="exchange__input-wrap-price">
                              0.050930000 USDT
                            </div>
                          </div>
            ...
            <div className="history">
              <div className="history__top">
                <Button classes="btn--active history__btn history__btn--active">
                  Open Orders
                </Button>
              ...
              <div className="history__table table">
                <div className="table__tr">
                  <div className="table__th">Date</div>
                  <div className="table__th">Pair</div>
                  <div className="table__th">Kind</div>
                  <div className="table__th">Order</div>
                  <div className="table__th">Average</div>
                  <div className="table__th">Price</div>
                  <div className="table__th">Amount</div>
                  <div className="table__th">Total</div>
                  <div className="table__th">All</div>
                </div>
                <div className="table__data">
                  <div className="table__tr">
                    <div className="table__td">04-16 10:05:40</div>
                    <div className="table__td">ALPACA/USDT</div>
                    <div className="table__td">Limit</div>
                    <div className="table__td">Complete</div>
                    <div className="table__td">0.6137</div>
                    <div className="table__td">0.6155</div>
                    <div className="table__td">21.1</div>
                    <div className="table__td">12.9391</div>
                    <div className="table__td">Completed</div>
                  </div>
                  <div className="table__tr">
                    <div className="table__td">04-16 10:05:40</div>
                    <div className="table__td">ALPACA/USDT</div>
