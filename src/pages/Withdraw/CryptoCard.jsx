    ...
    <>
      <div className="flex flex-col px-12 py-12 bg-app-black rounded-xl">
        ...
        <div className="flex h-16 px-5 py-5 mb-8 rounded-md bg-app-black-light">
          <input className="w-full bg-app-black-light placeholder:text-slate-700" placeholder='Enter Address Here'/>
        </div>
        <div className="flex justify-start mb-1">
          <div className="text-lg font-medium">
            Network
        ...
        <DropDownButton initialContent="Select Withdraw Network" contentList={networkList}/>
        ...
        <div className="flex items-center justify-center h-16 rounded-md cursor-pointer bg-app-blue hover:bg-app-blue" onClick={handleClickWithdraw}>
