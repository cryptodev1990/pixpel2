          ...
          <div className="row user-home__section user-home__section--offset">
            <div className="col-lg-3">
              <div className="user-home__card">
                <img
                  src="assets/images/UserHome/1.jpg"
                  alt=""
                  className="user-home__card-image "
                />
                <div className="user-home__card-name">CRYPRO BOTS</div>
                <div className="user-home__card-title">232 321+ users</div>
          ...
          <div className="user-home__nfts user-home__section user-home__section--offset">
            ...
            <div className="row-wrap user-home__row">
              <div className="user-home__nft">
                <button className="user-home__nft-btn"></button>
                <img
                  src="assets/images/market/nft-1.jpg"
                  className="user-home__nft-picture"
                  alt=""
                />
                <div className="user-home__nft-list">
                  <div className="user-home__nft-item">
                    <div className="user-home__nft-name">Name</div>
                    <div className="user-home__nft-value">Bid</div>
                  </div>
                  <div className="user-home__nft-item">
                    <div className="user-home__nft-name">Mustang</div>
                    <div className="user-home__nft-value">2 PIX</div>
                  </div>
                </div>
              </div>
              <div className="user-home__nft">
              ...
              <div className="col-lg-4">
                <div className="user-home__token-card">
                  <div className="user-home__token-card-picture">
                    ...
                    <img
                      src="assets/images/market/game-card.jpg"
                      className="user-home__nft-picture"
                      alt=""
                    />
                  </div>
                  <div className="user-home__token-card-list">
                    <div className="user-home__token-card-item">
                      <div className="user-home__token-card-name">USER</div>
                      <div className="user-home__token-card-value">100 K</div>
                    </div>
                    <div className="user-home__token-card-item">
                      <div className="user-home__token-card-name">USER</div>
                      <div className="user-home__token-card-value">100 K</div>
          ...
          <div className="user-home__token user-home__section user-home__section--offset">
            ...
            <div className="user-home__table table">
              <div className="table__tr">
                <div className="table__th">Name</div>
                <div className="table__th">Last Price</div>
                <div className="table__th">24h Change</div>
                <div className="table__th">Market Cap</div>
              </div>
              <div className="table__tr">
                <div className="table__td">
                  ...
                  />
                  BNB
                  <div className="table__full-name">BNB</div>
                </div>
                <div className="table__td">$45 832,04000</div>
                ...
                <div className="table__td table__td--chart">
                  <MarketChart
                    isGrowth={false}
                    data={[0.2, 0.5, 1, 0.1, 2, 0.5, 3, 2, 1]}
                    sizeChart={sizeChart}
                  ></MarketChart>
                </div>
              </div>
              <div className="table__tr">
                <div className="table__td">
                  <img
                    src="assets/images/UserHome/btc.png"
                    className="table__icon"
                    alt=""
                  />
                  BTC
                  <div className="table__full-name">Bitcoin</div>
                </div>
                <div className="table__td">$45 832,04000</div>
                <div className="table__td" style={{ color: "#2EBD85" }}>
                  -1.73%
                ...
                <div className="table__td table__td--chart">
                  <MarketChart
                    isGrowth={false}
                    data={[0.2, 0.5, 1, 0.1, 0, 0.5, 3, 2, 1]}
                    sizeChart={sizeChart}
                  ></MarketChart>
                </div>
              </div>
              <div className="table__tr">
                <div className="table__td">
                  <img
                    src="assets/images/UserHome/usdc.png"
                    className="table__icon"
                    alt=""
                  />
                  USDC
                  <div className="table__full-name">USD coin</div>
                </div>
                <div className="table__td">$45 832,04000</div>
                ...
                <div className="table__td table__td--chart">
                  <MarketChart
                    isGrowth={true}
                    data={[0.2, 0.5, 1, 0.1, 1, 0.5, 3, 2, 1]}
                    sizeChart={sizeChart}
                  ></MarketChart>
                </div>
              </div>
              <div className="table__tr">
                <div className="table__td">
                  <img
                    src="assets/images/UserHome/eth.png"
                    className="table__icon"
                    alt=""
                  />
                  ETH
                  <div className="table__full-name">Etherium</div>
                </div>
                <div className="table__td">$45 832,04000</div>
                <div className="table__td">-1.73%</div>
                <div className="table__td table__td--chart">
                  <MarketChart
                    isGrowth={false}
