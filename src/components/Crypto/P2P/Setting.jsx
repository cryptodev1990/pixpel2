    ...
    <div className="flex gap-5 justify-center">
      <div className="flex flex-col gap-2">
        ...
        <div className="rounded flex items-center px-3 bg-app-black-button py-2">
          <input className="text-gray-400 text-sm bg-app-black-button" placeholder="Enter Amount"></input>
          <div className=" border-r-2 px-3 border-gray-500 mr-2 text-lg">UAH</div>
