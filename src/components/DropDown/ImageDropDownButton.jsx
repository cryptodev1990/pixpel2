...
const ImageDropDownButton = (props) => {
  ...
  return(
    <div className={props.backgroundColor + (showDropDown ? " rounded-t-md" : " rounded-md")} onClick={handleDropDown}>
          ...
          showDropDown === true ? (
            <div className="absolute inset-0 z-10">
                ...
                onClick={handleDropDown}
			  	    ></div> 
                <div className={props.backgroundColor + " flex flex-col rounded-b-md"}>
                  {
                    props.contentList.map( (content, idx) => {
                      return(
                        <div key={idx} className="relative flex flex-row items-center justify-start gap-1 px-5 py-3 border-b-2 border-app-black"
