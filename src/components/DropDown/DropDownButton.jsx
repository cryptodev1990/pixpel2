...
const DropDownButton = (props) => {
  ...
  return (
    <>
      ...
      >
        <div className="flex px-5 py-2 rounded-md gap-3 items-center justify-between">
          <div className="text-lg font-medium">{selectedContent}</div>
          <div className="flex">
            <svg
              ...
              <div className="flex flex-col bg-app-black-button rounded-b-md">
                {props.contentList.map((content, idx) => {
                  return (
                    <div
                      key={idx}
                      className="relative flex justify-start px-5 py-3"
                      onClick={() => {
