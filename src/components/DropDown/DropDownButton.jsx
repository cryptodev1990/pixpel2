...
const DropDownButton = (props) => {
  ...
  return(
    <>
     <div className={" bg-app-black-button" + (showDropDown ? " rounded-t-md" : " rounded-md")} onClick={handleDropDown}>
                    ...
                    <div className="flex flex-col bg-app-black-button rounded-b-md">
                      {
                        props.contentList.map( (content, idx) => {
                          return(
                            <div key={idx} className="relative flex justify-start px-5 py-3"
